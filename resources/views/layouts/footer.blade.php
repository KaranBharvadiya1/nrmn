<footer class="bg-gray-900 text-white pt-16 pb-8">
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div class="space-y-4">
        <a href="/" class="flex items-center text-[29px] md:text-[32px] font-extrabold text-white gap-1">
          <span class="w-10 h-10 bg-blue-600 text-white flex items-center justify-center rounded-full italic">N</span>
          <span class="italic">irmaan</span>
        </a>
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Project Tracking</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Resource Management</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Team Collaboration</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Budget Control</a></li>
          <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Quality Assurance</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <address class="not-italic text-gray-400 space-y-2">
          <p class="flex items-start">
            ...
            100 Construction Plaza, Mumbai, MH 400001
          </p>
    ...
    <div class="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
      <p class="text-gray-400 text-sm">
        &copy; 2025 Nirmaan. All rights reserved.
      </p>
